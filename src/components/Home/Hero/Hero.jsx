...
const Hero = () => {
  return (
    <div className=" mt-6 md:mt-12 mb-6 md:mb-12 max-w-7xl mx-auto">
      ...
      <h1 className=" text-5xl md:text-[180px] text-[#333333] text-center  font-bold">
        JACOB JONES
      </h1>
      ...
      <div>
        <img
          className=" rounded-2xl  mx-auto aspect-video md:w-full"
